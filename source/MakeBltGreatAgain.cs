...
public class BLTGuardModule : MBSubModuleBase
    ...
    public class MBGAUpgradePartySizeModel : TaleWorlds.CampaignSystem.ComponentInterfaces.PartySizeLimitModel
    {
        ...
        public override List<TaleWorlds.CampaignSystem.Naval.Ship> FindAppropriateInitialShipsForMobileParty(MobileParty party, PartyTemplateObject partyTemplate)
        ...
        public override ExplainedNumber CalculateGarrisonPartySizeLimit(Settlement settlement, bool includeDescriptions = true)
        ...
        public override int GetClanTierPartySizeEffectForHero(Hero hero) => _previous.GetClanTierPartySizeEffectForHero(hero);

        public override int GetNextClanTierPartySizeEffectChangeForHero(Hero hero) => _previous.GetNextClanTierPartySizeEffectChangeForHero(hero);

        public override int GetAssumedPartySizeForLordParty(Hero leaderHero, IFaction partyMapFaction, Clan actualClan)
            => _previous.GetAssumedPartySizeForLordParty(leaderHero, partyMapFaction, actualClan);

        public override int GetIdealVillagerPartySize(Village village) => _previous.GetIdealVillagerPartySize(village);

        public override TaleWorlds.CampaignSystem.Roster.TroopRoster FindAppropriateInitialRosterForMobileParty(MobileParty party, PartyTemplateObject partyTemplate)
    ...
    public class MBGAUpgradePartySpeedModel : TaleWorlds.CampaignSystem.ComponentInterfaces.PartySpeedModel
    {
        ...
        public override ExplainedNumber CalculateBaseSpeed(MobileParty party, bool includeDescriptions = false, int additionalTroopOnFootCount = 0, int additionalTroopOnHorseCount = 0)
            => _previous.CalculateBaseSpeed(party, includeDescriptions, additionalTroopOnFootCount, additionalTroopOnHorseCount);
